        ...
        child: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if(snapshot.data == null){
              ...
              if(snapshot.data=="Lamentamos los inconvenientes, servidor en mantenimiento"){
                return Container(
                  child: Center(
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  children:<Widget>[
                   Text("Tuxtepec",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w700)),
                    Text("15 Km de Tuxtepec",style: TextStyle(fontSize: 12))
